...
// Try to use latin characters only
// Don't do for example: var präsident 

/*
 * The variable "firstname" is bound to the scope of the function.
 * The console.log() will throw an error, as it cannot access it
 * from the outside.
 *
 * Uncomment the console.log() to try!
 */
...
/*
 * The variable "dogYears" is bound to the scope of the IF code block.
 * The console.log() will throw an error, as it cannot access it
 * from the outside.
 *
 * Uncomment the console.log() to try!
...
/*
 * Be aware of the scope, as you can re-define the variable with
 * let, if it's in a different scope. Youl should really try
 * to use global variables very rarely.
 */
...
// Returns "500" as the second definition of "points" does only
// exist in the scope of the IF statement.
...
/*
 * Constants cannot be updated, so the following definition would
 * result in an error.
 *
 * Uncomment the definition to try!
 */

// lastname = 'Muller';

// Constants that are defined in a global namespace, are written
// with uppercase letters, as a de-facto standard
 ...
 * by using the Object.freeze() method.
 * 
